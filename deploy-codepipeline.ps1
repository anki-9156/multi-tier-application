...
Write-Host "🚀 AWS CodePipeline Deployment Script" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan

# Get GitHub token from environment variable
$GITHUB_TOKEN = $env:GITHUB_TOKEN
if (-not $GITHUB_TOKEN) {
    Write-Host "❌ GitHub token not found in environment variable GITHUB_TOKEN" -ForegroundColor Red
    Write-Host "Please set the GITHUB_TOKEN environment variable" -ForegroundColor Yellow
    Write-Host "Go to: https://github.com/settings/tokens" -ForegroundColor Blue
